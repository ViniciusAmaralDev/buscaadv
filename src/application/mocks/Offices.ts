export const offices: Record<string, string[]> = {
  "Especialista em Direito Civil": [
    ...
    "Direito das contratos.",
    "Direito das responsabilidades civis.",
  ...
  "Especialista em Direito Trabalhista": [
    ...
    "Negociação coletiva e sindicalismo",
  ...
  "Especialista em Direito Tributário": [
    ...
    "Contencioso tributário (processos administrativos e judiciais)",
